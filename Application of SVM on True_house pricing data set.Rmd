...
MSE_Reg0 <- mean((pred0 - train_HousePriceData$TARGET.PRICE_IN_LACS.)^2)
MAE_Reg0 <- mean(abs(pred0 - train_HousePriceData$TARGET.PRICE_IN_LACS.))
MAPE_Reg0 <- mean(abs((pred0 - train_HousePriceData$TARGET.PRICE_IN_LACS.)/train_HousePriceData$TARGET.PRICE_IN_LACS.))
...
#prediction error on training data set
MSE_Lin1 <- mean((pred11 - train_HousePriceData$TARGET.PRICE_IN_LACS.)^2)
MAE_Lin1 <- mean(abs(pred11 - train_HousePriceData$TARGET.PRICE_IN_LACS.))
MAPE_Lin1 <- mean(abs((pred11 - train_HousePriceData$TARGET.PRICE_IN_LACS.)/train_HousePriceData$TARGET.PRICE_IN_LACS.))
...
MSE_Pol1 <- mean((pred21 - train_HousePriceData$TARGET.PRICE_IN_LACS.)^2)
MAE_Pol1 <- mean(abs(pred21 - train_HousePriceData$TARGET.PRICE_IN_LACS.))
MAPE_Pol1 <- mean(abs((pred21 - train_HousePriceData$TARGET.PRICE_IN_LACS.)/train_HousePriceData$TARGET.PRICE_IN_LACS.))
...
#prediction error on train data set
MSE_Rad1 <- mean((pred31 - train_HousePriceData$TARGET.PRICE_IN_LACS.)^2)
MAE_Rad1 <- mean(abs(pred31 - train_HousePriceData$TARGET.PRICE_IN_LACS.))
MAPE_Rad1 <- mean(abs((pred31 - train_HousePriceData$TARGET.PRICE_IN_LACS.)/train_HousePriceData$TARGET.PRICE_IN_LACS.))
...
#prediction error on train data set
MSE_Sig1 <- mean((pred41 - train_HousePriceData$TARGET.PRICE_IN_LACS.)^2)
MAE_Sig1 <- mean(abs(pred41 - train_HousePriceData$TARGET.PRICE_IN_LACS.))
MAPE_sig1 <- mean(abs((pred41 - train_HousePriceData$TARGET.PRICE_IN_LACS.)/train_HousePriceData$TARGET.PRICE_IN_LACS.))
```
